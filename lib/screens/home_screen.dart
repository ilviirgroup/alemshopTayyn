...
class HomeScreen extends StatefulWidget {
  ...
  final bool man;
  final bool woman;
  HomeScreen({this.category=true,this.subcategory,this.tabIndex=0,this.man=true,this.woman=true});
...
void changeGenderFilter(int gender){
 setState(() {
  ...
  void initState() {
    ...
    _sahypalar=[
      {
        'sahypa':widget.category? CategoryGridView(woman: widget.man,man: widget.woman,):SubCategory(subcategory: widget.subcategory,genderFilter: genderFilter,),
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        drawer:AppDrawer(genderChanger: changeGenderFilter,man: widget.man,woman: widget.woman,),
